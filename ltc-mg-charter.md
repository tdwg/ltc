...
<!-- YAML header for the charter as page on TDWG website -->
---
title: Latimer Core
description: >
...
<!-- Headings begin with level 2, i.e., two hash symbols (#). Levels 2 and 3 (if present) will appear as table of contents (toc) in right panel -->

<!-- Most of the headings below are optional. They sections can be re-ordered if that makes sense. -->
