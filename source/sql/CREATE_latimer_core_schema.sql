...
DROP DATABASE IF EXISTS latimer_core_schema;

CREATE DATABASE latimer_core_schema CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE identifier (
  ...
  hasReference varchar(255) DEFAULT NULL COMMENT 'This property refers to one or more related instances of the Reference class.',
...
--
-- Table latimer_core.identifier does not contain any data (it is empty)

--
-- Dumping data for table reference
--
-- Table latimer_core.reference does not contain any data (it is empty)

--
-- Dumping data for table measurementorfact
--
-- Table latimer_core.measurementorfact does not contain any data (it is empty)

--
-- Dumping data for table storagelocation
--
-- Table latimer_core.storagelocation does not contain any data (it is empty)
...
--
-- Table latimer_core.address does not contain any data (it is empty)

--
-- Dumping data for table person
--
-- Table latimer_core.person does not contain any data (it is empty)

--
-- Dumping data for table organisationalunit
--
-- Table latimer_core.organisationalunit does not contain any data (it is empty)

--
-- Dumping data for table temporalcoverage
--
-- Table latimer_core.temporalcoverage does not contain any data (it is empty)

--
-- Dumping data for table personrole
--
-- Table latimer_core.personrole does not contain any data (it is empty)

--
-- Dumping data for table schemeterm
--
-- Table latimer_core.schemeterm does not contain any data (it is empty)

--
-- Dumping data for table schememeasurementorfact
--
-- Table latimer_core.schememeasurementorfact does not contain any data (it is empty)

--
-- Dumping data for table event
--
-- Table latimer_core.event does not contain any data (it is empty)

--
-- Dumping data for table taxon
--
-- Table latimer_core.taxon does not contain any data (it is empty)

--
-- Dumping data for table resourcerelationship
--
-- Table latimer_core.resourcerelationship does not contain any data (it is empty)

--
-- Dumping data for table objectclassification
--
-- Table latimer_core.objectclassification does not contain any data (it is empty)

--
-- Dumping data for table latimercorescheme
--
-- Table latimer_core.latimercorescheme does not contain any data (it is empty)

--
-- Dumping data for table geologicalcontext
--
-- Table latimer_core.geologicalcontext does not contain any data (it is empty)

--
-- Dumping data for table geographiccontext
--
-- Table latimer_core.geographiccontext does not contain any data (it is empty)

--
-- Dumping data for table ecologicalcontext
--
-- Table latimer_core.ecologicalcontext does not contain any data (it is empty)

--
-- Dumping data for table collectionstatushistory
--
-- Table latimer_core.collectionstatushistory does not contain any data (it is empty)

--
-- Dumping data for table chronometricage
--
-- Table latimer_core.chronometricage does not contain any data (it is empty)

--
-- Dumping data for table role
--
-- Table latimer_core.role does not contain any data (it is empty)

--
-- Dumping data for table recordlevel
--
-- Table latimer_core.recordlevel does not contain any data (it is empty)

--
-- Dumping data for table objectgroup
--
-- Table latimer_core.objectgroup does not contain any data (it is empty)
